...
@testset "DAV2020modified-FLUXES" begin
    ...
    if !is_a_CI_system && plot_flag
        ...
        pl_fluxes = plot(
            plot(d_out, [simulated_fluxes.cum_d_prec      loaded["cum_d_prec"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_prec", ),
            plot(d_out, [simulated_fluxes.cum_d_rfal      loaded["cum_d_rfal"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_rfal", ),
            plot(d_out, [simulated_fluxes.cum_d_sfal      loaded["cum_d_sfal"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_sfal", ),
            plot(d_out, [simulated_fluxes.cum_d_rint      loaded["cum_d_rint"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_rint", ),
            plot(d_out, [simulated_fluxes.cum_d_sint      loaded["cum_d_sint"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_sint", ),
            plot(d_out, [simulated_fluxes.cum_d_rthr      loaded["cum_d_rthr"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_rthr", ),
            plot(d_out, [simulated_fluxes.cum_d_sthr      loaded["cum_d_sthr"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_sthr", ),
            plot(d_out, [simulated_fluxes.cum_d_rsno      loaded["cum_d_rsno"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_rsno", ),
            plot(d_out, [simulated_fluxes.cum_d_rnet      loaded["cum_d_rnet"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_rnet", ),
            plot(d_out, [simulated_fluxes.cum_d_smlt      loaded["cum_d_smlt"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_smlt", ),
            plot(d_out, [simulated_fluxes.cum_d_evap      loaded["cum_d_evap"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_evap", ),
            plot(d_out, [simulated_fluxes.cum_d_tran      loaded["cum_d_tran"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_tran", ),
            plot(d_out, [simulated_fluxes.cum_d_irvp      loaded["cum_d_irvp"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_irvp", ),
            plot(d_out, [simulated_fluxes.cum_d_isvp      loaded["cum_d_isvp"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_isvp", ),
            plot(d_out, [simulated_fluxes.cum_d_slvp      loaded["cum_d_slvp"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_slvp", ),
            plot(d_out, [simulated_fluxes.cum_d_snvp      loaded["cum_d_snvp"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_snvp", ),
            plot(d_out, [simulated_fluxes.cum_d_pint      loaded["cum_d_pint"]],     legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_pint", ),
            plot(d_out, [simulated_fluxes.cum_d_ptran     loaded["cum_d_ptran"]],    legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_ptran", ),
            # plot(d_out, [simulated_fluxes.cum_d_pslvp     loaded["cum_d_pslvp"]],    legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.cum_d_pslvp", ), # PSLVP was removed from output,
            plot(d_out, [simulated_fluxes.flow            loaded["flow"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.flow", ),
            plot(d_out, [simulated_fluxes.seep            loaded["seep"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.seep", ),
            plot(d_out, [simulated_fluxes.srfl            loaded["srfl"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.srfl", ),
            plot(d_out, [simulated_fluxes.slfl            loaded["slfl"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.slfl", ),
            plot(d_out, [simulated_fluxes.byfl            loaded["byfl"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.byfl", ),
            plot(d_out, [simulated_fluxes.dsfl            loaded["dsfl"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.dsfl", ),
            plot(d_out, [simulated_fluxes.gwfl            loaded["gwfl"]],           legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.gwfl", ),
            plot(d_out, [simulated_fluxes.vrfln           loaded["vrfln"]],          legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.vrfln", ),
            plot(d_out, [simulated_fluxes.totalSWAT       loaded["totalSWAT"]],      legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.totalSWAT", ),
            plot(d_out, [simulated_fluxes.new_totalWATER  loaded["new_totalWATER"]], legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.new_totalWATER", ),
            plot(d_out, [simulated_fluxes.BALERD_SWAT     loaded["BALERD_SWAT"]],    legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.BALERD_SWAT", ),
            plot(d_out, [simulated_fluxes.BALERD_total    loaded["BALERD_total"]],   legend = :topright, linestyle = [:solid :dot], label = ["simulated" "reference"], title = "accum.BALERD_total", ),
