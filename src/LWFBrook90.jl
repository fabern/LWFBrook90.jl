...
function run_simulation(args)
    ...
    sol_LWFBrook90 = solve(ode_LWFBrook90, Tsit5(); progress = true,
        ...
        adaptive = true, dtmin = 1e-4, dt=1e-3,  # if adaptive dt is just the starting value of the time steps
        ...
        maxiters = (tspan[2]-tspan[1])/1e-4 + 100 # when using force_dtmin also use maxiters
