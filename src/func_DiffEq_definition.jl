...
# function define_DiffEq_f()
    function f_LWFBrook90R(du,u,p,t)
        ...
        u_aux_WETNES, u_aux_PSIM, u_aux_PSITI, p_fu_KK =
            LWFBrook90Julia.KPT.LWFBrook90_derive_auxiliary_states(u_SWATI,
                                            p_SWATMX, p_THSAT, p_θr,
                                            p_PSIF, p_BEXP, p_WETINF, p_WETF,
                                            p_CHM, p_CHN, p_MvGα, p_MvGn, p_MvGl, p_Ksat, p_KF, p_PSIG,
                                            IMODEL, NLAYER)
        ...
        # du_NTFLI, DPSIDW, du_GWFL, du_SEEP) =
        #     MSBITERATE(p_QLAYER,
        #             # for SRFLFR:
        ...
        #             # for FDPSIDWF:
        #             u_aux_WETNES, p_WETINF, p_BEXP, p_PSIF, p_WETF, p_CHM, p_CHN,
        #             # for ITER:
        #             p_DSWMAX,
        #             # for GWATER:
        #             u_GWAT, p_GSC, p_GSP, p_DT) # iteration calculations
        # TODO(bernhard):
        ...
        # Update GWAT:
        du[1] = 0 #TODO: (aux_du_VRFLI[NLAYER] - du_GWFL - du_SEEP)
        ...
        #du[10] = 0
        #du[11] = 0
        du[7:(7+(NLAYER-1))] .= 0 #TODO: du_NTFLI[:]
        ...
        if compute_intermediate_quantities
            ...
            #TODO: du[7+NLAYER+2] = p_fu_SRFL + sum(aux_du_BYFLI) + sum(aux_du_DSFLI) + du_GWFL # SRFLD + BYFLD + DSFLD + GWFLD # was timeseries_flow
            ...
            #TODO: du[7+NLAYER+13]= p_fu_SLFL                            # was timeseries_slfld
            ...
            #TODO: du[7+NLAYER+21]= p_fu_SRFL                            # was timeseries_SRFLD
            #TODO: du[7+NLAYER+22]= du_SEEP                              # was timeseries_SEEP
            #TODO: du[7+NLAYER+23]= du_GWFL                              # was timeseries_GWFL
            #TODO: du[7+NLAYER+24]= aux_du_VRFLI[NLAYER]                 # was timeseries_VRFLN
            #TODO: du[7+NLAYER+25]= sum(aux_du_BYFLI)                    # was timeseries_BYFLD
            #TODO: du[7+NLAYER+26]= sum(aux_du_DSFLI)                    # was timeseries_DSFLD
...
function define_DiffEq_cb()
    ...
    function LWFBrook90R_update_INTS_INTR_SNOW_CC_SNOWLQ!(integrator)
        ...
        if IMODEL == 0
            u_aux_WETNES, u_aux_PSIM, u_aux_PSITI, p_fu_KK =
            LWFBrook90Julia.KPT.deriveAuxiliaryStates_CH(u_SWATI,  p_SWATMX,
